...
\end{cases}\]
where \(m\geq 2\) is an even number, and for all \(i\), \(I_i\) is a finite set and all \(n_{i,k}\) are odd numbers since \(X\) is a finite CW complex.
...
\end{cases}\]
where for all \(i\), \(I_i\) is a finite set and \(n_{i,k}\) are odd numbers since \(X\) is a finite CW complex.

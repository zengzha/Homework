...
Let \(C_*\) be a chain complex of abelian groups. Prove that \(\alpha\in \hom(C_n,B)\) is a cocycle in \(\hom(C_*,B)\) if and only if \(\alpha:C_*\rightarrow \Sigma^n B[0]\) is a chain map. 
